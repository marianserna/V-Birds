...
export default class Butterfly extends THREE.Group {
  ...
  buildRightWing() {
    ...
    let triangleMaterial = new THREE.MeshBasicMaterial({side: THREE.DoubleSide, color: 0x1794A5});
    ...
    triangleMaterial = new THREE.MeshBasicMaterial({side: THREE.DoubleSide, color: 0xF2C640});
